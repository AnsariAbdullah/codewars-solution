...
let movieName = "2001: A Space Odyssey";
let noNumRegex = /\D/g;
let result = movieName.match(noNumRegex);	// returns ["S","t","a","r","s"]
```
...
```
let whiteSpace = "Cat and dog"
let nonSpaceRegex = /\S/g;
whiteSpace.match(nonSpaceRegex);
// returns ['C', 'a', 't', 'a', 'n', 'd', 'd', 'o', 'g']
```
...
rainbowRegex.test(american);	// return true
rainbowRegex.test(british);		// return true
```
